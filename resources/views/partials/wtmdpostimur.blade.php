    ...
    <div class="bg-white shadow-md rounded-lg">
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content">
                <h2 class="text-xl font-bold text-black">Formulir Wtmd Pos Timur - Belum Diperiksa</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar formulir Wtmd Pos Timur yang belum selesai
                    diperiksa</h4>
                ...
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir Wtmd Pos Timur yang belum diperiksa saat ini.</p>
                </div>
                @endif
            </div>
            ...
            <div id="all-content" class="tab-content hidden">
                <h2 class="text-xl font-bold text-black">Semua Formulir Wtmd Pos Timur</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar lengkap semua formulir WTMD Pos Timur</h4>
                ...
                @else
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir WTMD Pos Timur saat ini.</p>
                </div>
                @endif
            </div>
