    ...
    <div class="bg-white shadow-md rounded-lg">
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content">
                <h2 class="text-xl font-bold text-black">Formulir WTMD Pscp Selatan - Belum Diperiksa</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar formulir WTMD Pscp Selatan yang belum selesai
                    diperiksa</h4>
                ...
                <div class="mb-4 p-4 bg-blue-100 text-blue-700 rounded-lg">
                    ...
                    <a href="{{ route('wtmdform') }}" class="text-blue-600 underline hover:text-blue-800">Reset
                        Filter</a>
                </div>
                @endif
                ...
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir WTMD Pscp Selatan yang belum diperiksa saat ini.</p>
                </div>
                @endif
            </div>
            ...
            <div id="all-content" class="tab-content hidden">
                <h2 class="text-xl font-bold text-black">Semua Formulir WTMD Pscp Selatan</h2>
                <h4 class="text-sm font-light text-black mb-4">Daftar lengkap semua formulir WTMD Pscp Selatan</h4>
                ...
                @else
                <div class="text-center py-8">
                    <p class="text-gray-500">Tidak ada formulir WTMD Pscp Selatan saat ini.</p>
                </div>
                @endif
            </div>
